...
#  end
  ...
  config.vm.define "IE8_Win7" do |v|
    v.vm.box = "IE8_Win7"
    v.vm.box_url = "file://IE8.Win7.For.Vagrant.box"
  ...
  config.vm.define "IE9_Win7" do |v|
    v.vm.box = "IE9_Win7"
    v.vm.box_url = "file://IE9.Win7.Win7.For.Vagrant.box"
    config.vm.provider :virtualbox do |vb|
            vb.name = "IE9_Win7"
    end
  end
  ...
  config.vm.define "IE10_Win7" do |v|
    v.vm.box = "IE10_Win7"
    v.vm.box_url = "file://IE10.Win7.For.Vagrant.box"
    config.vm.provider :virtualbox do |vb|
            vb.name = "IE10_Win7"
    end
  end
  ...
  config.vm.define "IE11_Win7" do |v|
    v.vm.box = "IE11_Win7"
    v.vm.box_url = "file://IE11.Win7.For.Vagrant.box"
    config.vm.provider :virtualbox do |vb|
            vb.name = "IE11_Win7"
    end
  end
